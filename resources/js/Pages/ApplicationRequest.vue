    ...
    <form action="">
        <div>
            <div class="mx-8 lg:max-w-6xl lg:mx-auto my-4">
                <h1 class="text-center lg:text-left text-2xl font-bold">Applying for {{ job_position }} at {{ company }}</h1>
                <div class="lg:max-w-5xl lg:mx-auto my-6">
                    <div class="mx-8 flex flex-col lg:flex-row justify-center items-center">
                        ...
                        <div class="lg:basis-1/3 flex flex-col justify-center p-6 mx-2 text-center lg:text-left">
                            <p class="text-gray-900 text-xl font-bold mb-2"> {{ form.name }} </p>
                            <p class="text-gray-700 text-base"> {{ form.description }} </p>
                            <p class="text-gray-700 text-base"> {{ form.email }} </p>
                        </div>
            ...
            <div id="resume_bg" class="w-screen my-6">
                <div class="mx-8 lg:max-w-6xl lg:mx-auto py-6">
                    <h1 class="text-center lg:text-left text-2xl font-bold">Resume</h1>
            ...
            <div class="lg:max-w-6xl lg:mx-auto py-6 mx-8 my-6">
                ...
                class="block text-center lg:text-left text-2xl font-bold">Additional comments</label>
