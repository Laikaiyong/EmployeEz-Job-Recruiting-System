                                    ...
                                    <template v-if="!($page.props.user.current_team_id==2 || $page.props.user.current_team_id==3)" #content>
                                        <div class="w-60">
                                            ...
                                            <template v-if="$page.props.jetstream.hasTeamFeatures">
                                                ...
                                                <jet-dropdown-link v-show="false" :href="route('teams.create')" v-if="$page.props.jetstream.canCreateTeams">
                                                    Create New Team
                                                </jet-dropdown-link>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <template v-if="$page.props.jetstream.hasTeamFeatures && !($page.props.user.current_team_id==2 || $page.props.user.current_team_id==3)">
                                ...
                                <jet-responsive-nav-link v-show="false" :href="route('teams.create')" :active="route().current('teams.create')" v-if="$page.props.jetstream.canCreateTeams">
                                    Create New Team
                                </jet-responsive-nav-link>
